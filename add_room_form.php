...
<form action="add_room.php" method="post">
	...
	<h2 style="padding-top: 15px; padding-left: 10px;"> <em> &#9658; OPERATIONAL DATA </em> </h2>
	...
	<h2 style="padding-left: 10px;"> <em> &#9658; ARCHITECTURE </em> </h2>
	...
	<h2 style="padding-left: 10px;"> <em> &#9658; COMMUNICATIONS DATA </em> </h2>
        <div>
	        <div  class="checkboxes">
				<label>
	...
	<h2 style="padding-left: 10px;"> <em> &#9658; ELECTRICAL DATA </em> </h2>
	...
	<h2 style="padding-left: 10px;"> <em> &#9658; MECHANICAL DATA </em> </h2>
    ...
    <hr>
    <h2 style="padding-left: 10px;"> <em>  &#9658; PLUMBING DATA </em> </h2>
    ...
    <div>
	    ...
	    <div>
		<b style="color: brown"> Water: </b> <br>
		<div class="checkboxes">
			<label>
				<input type="checkbox" name="Water[]" value="Domestic Hot Water (82ºC)"> Domestic Hot Water (82ºC)
			</label>
			<label>
				<input type="checkbox" name="Water[]" value="Domestic Hot Water (60ºC)"> Domestic Hot Water (60ºC)
			</label>
			<label>
				<input type="checkbox" name="Water[]" value="Domestic Hot Water (43ºC)"> Domestic Hot Water (43ºC)
			</label>
			<label>
				<input type="checkbox" name="Water[]" value="Domestic Cold Water"> Domestic Cold Water
			</label>
			<label>
				<input type="checkbox" name="Water[]" value="Softened Water"> Softened Water
			</label>
			<label>
				<input type="checkbox" name="Water[]" value="Fire Suppression Sprinkler"> Fire Suppression Sprinkler
			</label>
			<label>
				<input type="checkbox" name="Water[]" value="Distilled Water (Localized)"> Distilled Water (Localized)
			</label>
			<label>
				<input type="checkbox" name="Water[]" value="Dialysate Water (Localized)"> Dialysate Water (Localized)
			</label>
			<label>
				<input type="checkbox" name="Water[]" value="De-Ionized Water (Localized)"> De-Ionized Water (Localized)
			</label>
		</div>
	</div>
